...
void passaVez(char jogador1[], char jogador2[], int pontos[]);
...
int  inserirCasasNavio(char matriz[][8], int posicao[], int linhas, int colunas);
...
int main(){ 
    ...
    do {
        ...
        do {
            ...
            if(podePassarVez) {
                passaVez(nomeJogador1, nomeJogador2, pontos);
            }
...
void posicionarNavio(char matriz[][8], int linhas, int colunas) {
    ...
    for(int i = 0; i < 3; i++) {
        ...
        while(!jogadaValida) {
            ...
            jogadaValida = inserirCasasNavio(matriz, navio, linhas, colunas);
        }
